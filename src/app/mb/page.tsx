...
export default function HomePage() {
  const [patients, setPatients] = useState<IPatientDataMicro[]>([]);
  const [center, setCenter] = useState<string>("Bagerhat");
  const [currentPatient, setCurrentPatient] = useState<IPatientDataMicro | null>(null);
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="hidden">
        {currentPatient && (
          <div ref={reportRef}>
            <ReportPageMicro data={currentPatient} />
          </div>
        )}
      </div>
    </div>
